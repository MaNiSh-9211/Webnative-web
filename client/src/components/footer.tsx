        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/demo"><a className="text-[#9ca3af] hover:text-white transition duration-300">Demo</a></Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/about"><a className="text-[#9ca3af] hover:text-white transition duration-300">About</a></Link></li>
